...
public class AlmacenajeContenedoresTiempos {
    ...
    public static void main(String args[]) {
        ...
        String[] ficheros = {
            "CasosPrueba/test00.txt", "CasosPrueba/test01.txt", "CasosPrueba/test02.txt", "CasosPrueba/test03.txt",
             "CasosPrueba/test04.txt", "CasosPrueba/test05.txt", "CasosPrueba/test06.txt", "CasosPrueba/test07.txt",
              "CasosPrueba/test08.txt", "CasosPrueba/test09.txt"};
